		...
		if (TF2_GetClientTeam(x) == TFTeam_Red)
		{
			for (int i = 0; i < bluCursor; i++)
			{
				...
				PrintToConsole(x, "//                                                                    //\n//   BLU | %s\n//   %d goals, %d assists, %d saves, %d intercepts, %d steals              //\n//   %d Panaceas, %d win strats, %d deathbombs, %d handoffs               //\n//   %d first grabs, %d catapults, %d blocks, %d steal2saves              //\n//                                                                    //"
					...
					, arriPlyRoundPassStats[bluTeam[i]].iPlyDeathbombs, arriPlyRoundPassStats[bluTeam[i]].iPlyHandoffs
					, arriPlyRoundPassStats[bluTeam[i]].iPlyFirstGrabs, arriPlyRoundPassStats[bluTeam[i]].iPlyCatapults
					, arriPlyRoundPassStats[bluTeam[i]].iPlyBlocks, arriPlyRoundPassStats[bluTeam[i]].iPlySteal2Saves); // have this be red so your team shows up first?
			}
			...
			for (int i = 0; i < redCursor; i++)
			{
				...
				if(arrbJackAcqSettings[x].bPlySimpleChatPrintSetting && !arrbJackAcqSettings[x].bPlyToggleChatPrintSetting)
					...
					PrintToChat(x, "\x0700ffff[PASS]\x07C43F3B %s:\x073BC43B goals %d,\x073bc48f assists %d,\x07ffff00 saves %d,\x07ff00ff intercepts %d,\x07ff8000 steals %d"
						, playerName, arriPlyRoundPassStats[redTeam[i]].iPlyScores, arriPlyRoundPassStats[redTeam[i]].iPlyAssists, arriPlyRoundPassStats[redTeam[i]].iPlySaves
						, arriPlyRoundPassStats[redTeam[i]].iPlyIntercepts, arriPlyRoundPassStats[redTeam[i]].iPlySteals);
				PrintToConsole(x, "//                                                                    //\n//   RED | %s\n//   %d goals, %d assists, %d saves, %d intercepts, %d steals              //\n//   %d Panaceas, %d win strats, %d deathbombs, %d handoffs               //\n//   %d first grabs, %d catapults, %d blocks, %d steal2saves              //\n//                                                                    //"
					...
					, arriPlyRoundPassStats[redTeam[i]].iPlyDeathbombs, arriPlyRoundPassStats[redTeam[i]].iPlyHandoffs
					, arriPlyRoundPassStats[redTeam[i]].iPlyFirstGrabs, arriPlyRoundPassStats[redTeam[i]].iPlyCatapults
